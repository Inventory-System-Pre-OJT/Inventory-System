          ...
          <ul className="flex flex-col content-between h-full space-y-2 font-medium">
            <div className="flex flex-col justify-between h-full space-y-2">
                <div className="font-medium">
                    ...
                    <li>
                    <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <FaBuilding className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                        <span className="flex-1 ms-3 text-start whitespace-nowrap">Branches</span>
                    </a>
                    </li>
                </div>
